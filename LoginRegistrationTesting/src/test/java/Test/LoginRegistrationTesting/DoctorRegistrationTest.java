...
public class DoctorRegistrationTest {
	...
	public void login() {
		...
		webdriver.findElement(By.id("email")).sendKeys("Raj@gmail.com");
		webdriver.findElement(By.id("password")).sendKeys("raj123");
		WebElement radio1 = webdriver.findElement(By.id("doctorRole"));
		radio1.click();
